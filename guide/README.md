...
![AIOmetadata Access rules](<.gitbook/assets/Screenshot 2026-09-17 205612.png>)
...
That is it for provider. Now to add indexers, Go to addons->marketplace-> Newznab and add details of your usenet indexer and click install at the bottom. Also add "AIOstreams" under service section if you happen to have Torbox pro and want to use instant usenet streaming instead of usual Torbox cache and play. If don't have an indexer check section [8.2.2](./#id-8.2.2-usenet-indexers) for general recommendations.

<figure><img src="https://i.postimg.cc/jjxpKV14/Screenshot-2026-07-05-184317.png" alt=""><figcaption></figcaption></figure>

Once you have finished installing the addon. Save your aiostreams config and install it on a client of your choice if you haven't already. You should now see usenet results on stremio that can stream instantly via usenet.
